...
export interface ITelemetryTracer {
    startActiveSpan<T>(name: string, fn: (span: ITelemetrySpan) => T | Promise<T>): T | Promise<T>;
    startActiveSpanWithAttributes<T>(name: string, attributes: ITelemetryAttributes, fn: (span: ITelemetrySpan) => T | Promise<T>): T | Promise<T>;
}
